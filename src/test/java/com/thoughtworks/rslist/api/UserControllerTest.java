...
public class UserControllerTest {
    ...
    void should_register_user() throws Exception {
        UserDto userDto = new UserDto("li", "gender", 18, "823260355@qq.com", "15991047255");
        validPost(userDto, "/user/register", status().is(201));
    }

    @Test
    void should_register_fail_when_name_is_empty() throws Exception {
        UserDto userDto = new UserDto("", "gender", 18, "823260355@qq.com", "15991047255");
        validPost(userDto, "/user/register", status().isBadRequest());
    }

    @Test
    void should_register_fail_when_name_size_more_then_8() throws Exception {
        UserDto userDto = new UserDto("123456789", "gender", 18, "823260355@qq.com", "15991047255");
        validPost(userDto, "/user/register", status().isBadRequest());
    }

    @Test
    void should_register_fail_when_gender_is_empty() throws Exception {
        UserDto userDto = new UserDto("name", "", 18, "823260355@qq.com", "15991047255");
        validPost(userDto, "/user/register", status().isBadRequest());
    }

    @Test
    void should_register_fail_when_age_is_empty() throws Exception {
        UserDto userDto = new UserDto("name", "gender", null, "823260355@qq.com", "15991047255");
        validPost(userDto, "/user/register", status().isBadRequest());
    }

    @Test
    void should_register_fail_when_age_is_less_then_18() throws Exception {
        UserDto userDto = new UserDto("name", "gender", 17, "823260355@qq.com", "15991047255");
        validPost(userDto, "/user/register", status().isBadRequest());
    }

    @Test
    void should_register_fail_when_age_is_more_then_100() throws Exception {
        UserDto userDto = new UserDto("name", "gender", 101, "823260355@qq.com", "15991047255");
        validPost(userDto, "/user/register", status().isBadRequest());
    }

    @Test
    void should_register_fail_when_email_not_standard() throws Exception {
        UserDto userDto = new UserDto("name", "gender", 18, "email", "15991047255");
        validPost(userDto, "/user/register", status().isBadRequest());
    }

    @Test
    void should_register_fail_when_phone_not_standard() throws Exception {
        UserDto userDto = new UserDto("name", "gender", 18, "823260355@qq.com", "phone");
        validPost(userDto, "/user/register", status().isBadRequest());
    }
